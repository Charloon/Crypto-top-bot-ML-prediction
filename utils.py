...
def TimeStampDiff(n_candle, TimeFrame):
    TimestampMin = {"1m": n_candle*60*1000, "3m": n_candle*3*60*1000, "5m": n_candle*5*60*1000, "15m": n_candle*15*60*1000, "30m": n_candle*30*60*1000, 
                "1h": n_candle*3600*1000, "2h": n_candle*2*3600*1000, "4h": n_candle*4*3600*1000, "6h": n_candle*3*3600*1000, "8h": n_candle*8*3600*1000,
                "12h": n_candle*12*3600*1000, "1d": n_candle*24*3600*1000, "3d": n_candle*3*24*3600*1000, "1w": n_candle*7*24*3600*1000,
